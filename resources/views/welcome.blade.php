...
<body class="font-sans antialiased">
                ...
                <div class="flex">
                    ...
                    <div class="shrink-0 flex items-center">
                        <div class="logo-container">
                            <img src="{{ asset('images/logo_C-GIS.png') }}" alt="Logo" class="logo-image" />
                            <span class="logo-text">C-GIS</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    @if (Route::has('login'))
        <div class="hidden fixed top-0 right-0 px-8 py-7 sm:block">
            @auth
                <a href="{{ url('/dashboard') }}" class="text-sm text-gray-200 dark:text-gray-500 underline">Dashboard</a>
            @else
